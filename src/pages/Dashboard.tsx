  ...
  const preloadedUsers: PreloadedUser[] = [
    {
      ...
      "email": "elizabeth.hernandez@email.com",
      "condition": "type 2 diabetes",
      "language": "en",
      "literacy_level": "high",
      "age_group": "71+",
      "summary": "Seeking resources for managing type 2 diabetes",
    ...
    },
    {
      "id": "2",
      "name": "George Allen",
      "email": "george.allen@email.com",
      "condition": "COPD",
      "language": "en",
      "literacy_level": "low",
      "age_group": "51-70",
      "summary": "Looking for COPD treatment support",
